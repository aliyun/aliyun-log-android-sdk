...
#include <jni.h>
#include "libs/producer/include/log_producer_client.h"
...
{
    JNIEnv *env;
    int get_env_stat = (*g_VM)->GetEnv(g_VM, (void **) &env,JNI_VERSION_1_6);
    ...
    jmethodID java_callback_id = (*env)->GetMethodID(env, java_class,
                                                   "onCall", "(ILjava/lang/String;Ljava/lang/String;II)V");
    ...
    //执行回调
    (*env)->CallVoidMethod(env, g_obj, java_callback_id, result, req_id_jstr_buf, message_jstr_buf, log_bytes, compressed_bytes);
    //释放当前线程
    (*g_VM)->DetachCurrentThread(g_VM);
    env = NULL;
}
 ...
 */
JNIEXPORT jlong JNICALL Java_com_aliyun_sls_android_producer_LogProducerClient_create_1log_1producer
 ...
 * Signature: (Ljava/lang/Object;)Ljava/lang/Object;
 */
JNIEXPORT jlong JNICALL Java_com_aliyun_sls_android_producer_LogProducerClient_get_1log_1producer_1client
 ...
 */
JNIEXPORT void JNICALL Java_com_aliyun_sls_android_producer_LogProducerClient_destroy_1log_1producer
  (JNIEnv *env, jclass obj, jlong producer){
...
/*
 * Class:     com_aliyun_sls_android_producer_LogProducerClient
 * Method:    log_producer_env_destroy
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_aliyun_sls_android_producer_LogProducerClient_log_1producer_1env_1destroy
