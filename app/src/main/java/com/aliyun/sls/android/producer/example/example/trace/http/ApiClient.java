...
public class ApiClient {
    ...
    public static void getCustomers(String id, ApiCallback<UserModel> callback) {
        ThreadUtils.exec(() -> {
            String url = "http://sls-mall.caa227ac081f24f1a8556f33d69b96c99.cn-beijing.alicontainer.com/customers/" + id;
            HttpTool.Response response = HttpTool.get(url);
            if (response.success()) {
